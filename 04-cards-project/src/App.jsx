  ...
  return (
    <div className="parent">
      {jobOpenings.map(function(elem,idx){
        ...
        return <div key={idx}>
          <Card key={idx} logo={elem.brandLogo} company={elem.companyName} date={elem.datePosted} post={elem.post} tag1={elem.tag1} pay={elem.pay} tag2={elem.tag2} location={elem.location} />
